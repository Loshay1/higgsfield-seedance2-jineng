...
| 11 | [Social Hook](skills/11-social-hook/SKILL.md) | Viral content — scroll-stopping hooks |
...
| Input | Format | Limit |
|---|---|---|
| Image | jpeg, png, webp, bmp, tiff, gif | ≤ 9, each < 30MB |
| Video | mp4, mov | ≤ 3, each < 50MB, total 2–15s |
| Audio | mp3, wav | ≤ 3, each < 15MB, total ≤ 15s |
...
- **Skills:** 15
- **Total SKILL.md files:** 15 (English)
